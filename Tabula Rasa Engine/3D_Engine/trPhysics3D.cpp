...
#ifdef _DEBUG
	#pragma comment (lib, "3D_Engine/Bullet/libx86/BulletDynamics_debug.lib")
	#pragma comment (lib, "3D_Engine/Bullet/libx86/BulletCollision_debug.lib")
	#pragma comment (lib, "3D_Engine/Bullet/libx86/LinearMath_debug.lib")
#else
	#pragma comment (lib, "3D_Engine/Bullet/libx86/BulletDynamics.lib")
	#pragma comment (lib, "3D_Engine/Bullet/libx86/BulletCollision.lib")
	#pragma comment (lib, "3D_Engine/Bullet/libx86/LinearMath.lib")
#endif
