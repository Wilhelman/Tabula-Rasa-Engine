...
// ------------------------------------------------------------
void trPrimitive::InnerRender() const
{
	glPointSize(5.0f);
...
// LINE ==================================================
PLine::PLine() : trPrimitive(), origin(0, 0, 0), destination(1, 1, 1)
{
	type = PrimitiveTypes::Primitive_Line;
}

PLine::PLine(float x, float y, float z) : trPrimitive(), origin(0, 0, 0), destination(x, y, z)
{
	type = PrimitiveTypes::Primitive_Line;
}
